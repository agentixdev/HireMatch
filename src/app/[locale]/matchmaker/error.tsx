...
export default function MatchmakerError({ error, reset }: { error: Error & { digest?: string }; reset: () => void }) {
  useEffect(() => { console.error('Matchmaker error:', error); }, [error]);
  return (
    <div className="min-h-screen flex items-center justify-center bg-[#0F172A]">
      <div className="text-center px-4 max-w-md">
        ...
        <p className="text-white/50 text-sm mb-6">The matchmaker encountered an error. Your progress has been saved.</p>

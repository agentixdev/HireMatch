      ...
      fallback={
        <div className="min-h-screen flex items-center justify-center bg-[#0B1120]">
          <div className="text-center px-6 py-10 rounded-2xl bg-white/[0.03] ring-1 ring-white/[0.08] max-w-lg">
            ...
            <h2 className="text-xl font-bold text-white mb-2">Onboarding error</h2>
            <p className="text-white/60 text-sm mb-6">
              Something went wrong during setup. Your progress has been saved — please refresh to continue.
            </p>
            <button

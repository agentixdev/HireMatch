...
export const metadata: Metadata = {
  ...
  description: 'Recruitment insights, visa guides, career tips, and hiring best practices from HireMatch.',
};
    ...
    <>
      ...
      {blogPosts.length === 0 ? (
        <div className="text-center py-20">
          ...
          <h2 className="text-lg font-medium text-white/60 mb-2">No posts yet</h2>
          <p className="text-white/30 text-sm">Check back soon for new articles.</p>
        </div>
      ) : (
